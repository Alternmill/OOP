...
public:
	Map(int screen_height, int screen_width, float rel_pos_x, float rel_pos_y,  float rel_width,float rel_height, int num_col, int num_row,Shader &shader_on,Shader &shader_off);
	void Draw_On();
